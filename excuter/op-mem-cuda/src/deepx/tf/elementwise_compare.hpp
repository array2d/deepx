    ...
    public:
        ...
        int run(shared_ptr<MemBase> mem, string &error) override
        {
            ...
            case Precision::Float32:
                ...
                break;
            case Precision::Float16:
                tensorfunc::compare<Author, half>(*mem->gettensor<half>(this->args[0].textvalue), *mem->gettensor<half>(this->args[1].textvalue), *mem->gettensor<int8_t>(this->returns[0].textvalue));
                break;
            case Precision::BFloat16:
                tensorfunc::compare<Author, nv_bfloat16>(*mem->gettensor<nv_bfloat16>(this->args[0].textvalue), *mem->gettensor<nv_bfloat16>(this->args[1].textvalue), *mem->gettensor<int8_t>(this->returns[0].textvalue));
                break;
            case Precision::Int64:
